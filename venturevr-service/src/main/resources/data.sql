...
VALUES (NULL, 'simon', '123', false);
INSERT INTO user (user_id, user_name, password, enabled)
VALUES (NULL,'frank', '456', false);

INSERT INTO account (acc_id, first_name, last_name, address, contact_no, email, bio, user_name, acc_details, date_account_created)
...
errem elaboraret usu.', 'simon', 'acc1234545ff', NULL);
INSERT INTO account (acc_id, first_name, last_name, address, contact_no, email, bio, user_name, acc_details, date_account_created)
...
et errem elaboraret usu.', 'frank', 'acc34577hhueih8', NULL);
